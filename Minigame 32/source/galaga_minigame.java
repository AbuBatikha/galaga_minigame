...
public class galaga_minigame extends PApplet {
...
public void setup() {
  ...
  randomColour = PApplet.parseInt(random(1,2));
  if(randomColour == 2){
    craftColour = 200;
  }else {
    craftColour = 255;
  ...
  enemy = true;
  enemyPosition = PApplet.parseInt(random(1,8))*10;
}
...
public void resetGame(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "galaga_minigame" };
    if (passedArgs != null) {
